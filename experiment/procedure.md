...
4. Click on Start button   <img src="images/startButton.png" alt="Alt text" > to perform the experiment, click on the Next button <img src="images/nextButton.png" alt="Alt text" > to  to move to the Observation page.

   ![Alt text](images/nextscreen.png)
